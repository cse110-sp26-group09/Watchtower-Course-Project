...
Support design/product decisions


James — Frontend Lead

Lead dashboard frontend structure
Help define main UI pages/components
...
Help make the product feel clear and usable
...
Prototype error logging using client-side JS
...
Document any useful GenAI contributions
...
Mobbing for project understanding, MVP definition, sprint planning, and wireframe review  
Pairing for prototype work, frontend dashboard work, and instrumentation research  
Solo work for clearly defined documentation, research notes, and small setup tasks  


No major task should be worked on without a GitHub Issue. Each task should have an owner, a support person, and a reviewer.
