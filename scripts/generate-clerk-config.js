...
/**
 * Generate src/frontend/auth/clerk-config.js from CLERK_PUBLISHABLE_KEY.
 *
...
const OUTPUT_PATH = path.join(REPO_ROOT, "src", "frontend", "auth", "clerk-config.js");
...
if (!/^pk_(test|live)_/.test(publishableKey)) {
  ...
  console.log("[config:clerk] Wrote src/frontend/auth/clerk-config.js");
}
