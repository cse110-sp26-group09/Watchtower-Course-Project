...
The framework-free Node.js HTTP server and data layer. Started
...
| File | Purpose |
|---|---|
| `server.js` | HTTP routing, JSON API (`/api/*`), static serving of `src/frontend` and `src/sdk`, Clerk JWT verification. |
