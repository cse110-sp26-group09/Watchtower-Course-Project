...
/**
 * Event utility helpers shared by the WatchTower server and tests.
 *
 * These functions are intentionally small, pure, and free of any I/O so
 * they are easy to unit test and reuse from server-side code or future
 * tooling. They mirror the event shape produced by the WatchTower SDK
 * (see `sdk/watchtower.js`) and consumed by the dashboard.
 *
 * @module event-utils
 */
